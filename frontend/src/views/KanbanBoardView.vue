...
/* Board Layout - Centered & Scrollable */
.board {
  display: flex;
...
.priority-select:focus {
  border-color: #8e63f1; 
  box-shadow: 0 0 0 3px rgba(142, 99, 241, 0.15); /* Soft indigo glow */
}
...
@media (max-width: 950px) {
  .board {
    justify-content: flex-start; /* Switch to left-aligned scrolling when screen gets too narrow */
  }
}
</style>